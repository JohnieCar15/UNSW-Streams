...
def test_public_channel_invite():
    ...
    channel_join_v1(valid_auth_id, valid_channel_id)
    channel_invite_v1(valid_auth_id, valid_channel_id, valid_invitee_id)

    channel_members = channel_details_v1(valid_auth_id, valid_channel_id)['all_members']
    channel_members_ids = [user['u_id'] for user in channel_members]

    assert valid_invitee_id in channel_members_ids
