...
def test_normal_case(clear_then_crete_public0_and_private0):
    ...
    assert sort_list(channels_listall_v1(uid)['channels']) == sort_list([{'channel_id': public_0_id, 'name': 'public_0'}, {'channel_id': private_0_id, 'name': 'private_0'}])
...
def test_complex_case():
    ...
    assert sort_list(channels_listall_v1(user_in_no_channels)['channels']) == list_of_all_channels
    assert sort_list(channels_listall_v1(member_in_all_channels)['channels']) == list_of_all_channels
    assert sort_list(channels_listall_v1(public_0_owner)['channels']) == list_of_all_channels
    assert sort_list(channels_listall_v1(public_0_member)['channels']) == list_of_all_channels
    assert sort_list(channels_listall_v1(private_0_owner)['channels']) == list_of_all_channels
    assert sort_list(channels_listall_v1(private_0_member)['channels']) == list_of_all_channels
    assert sort_list(channels_listall_v1(public_1_owner)['channels']) == list_of_all_channels
    assert sort_list(channels_listall_v1(public_2_owner)['channels']) == list_of_all_channels
    assert sort_list(channels_listall_v1(private_1_owner)['channels']) == list_of_all_channels
