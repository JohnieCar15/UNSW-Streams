...
def test_valid_user_not_in_any_channel():
    ...
    user_in_no_channels = auth_register_v1("0004@unsw.edu.au", "password", "firstname4","lastname4")
...
def test_owner_of_one_public_channel(clear_then_crete_public0_and_private0):
    public_0_owner = auth_login_v1("0000@unsw.edu.au", "password")
    assert channels_list_v1(public_0_owner) == {'channels':[{ 'channel_id': 1,'name': "public_0",}],}

def test_member_of_one_public_channel(clear_then_crete_public0_and_private0):
    public_0_member = auth_login_v1("0001@unsw.edu.au", "password")
    assert channels_list_v1(public_0_member) == {'channels':[{ 'channel_id': 1,'name': "public_0",}],}

def test_owner_of_one_private_channel(clear_then_crete_public0_and_private0):
    private_0_owner = auth_login_v1("0002@unsw.edu.au", "password")
    assert channels_list_v1(private_0_owner) == {'channels':[{ 'channel_id': 2,'name': "private_0",}],}

def test_member_of_one_private_channel(clear_then_crete_public0_and_private0):
    private_0_member = auth_login_v1("0003@unsw.edu.au", "password")
...
def test_complex_case(clear_then_crete_public0_and_private0):
    ...
    public_1_owner = auth_register_v1("0005@unsw.edu.au", "password", "firstname5","lastname5")
    public_1 = channels_create_v1(public_1_owner, "public_1", True)

    # register public_2_owner and create channel public_2
    public_2_owner = auth_register_v1("0006@unsw.edu.au", "password", "firstname6","lastname6")
    public_2 = channels_create_v1(public_2_owner, "public_2", True)

    # register private_1_owner and create channel private_1
    private_1_owner = auth_register_v1("0007unsw.edu.au", "password", "firstname7","lastname7")
    private_1 = channels_create_v1(private_1_owner, "private_1", False)

    member_in_all_channels = auth_register_v1("0008unsw.edu.au", "password", "firstname8","lastname8")
