...
def test_invalid_token_and_valid_handle(clear_and_register_user0):
    ...
    assert requests.put(config.url + '/user/profile/sethandle/v1/', data=input).status_code == AccessError.code
...
def test_handle_used_by_others(clear_and_register_user0):
    ...
    assert requests.put(config.url + '/user/profile/sethandle/v1/', data=input).status_code == InputError.code
...
def test_valid_token_and_valid_handle(clear_and_register_user0):
    ...
    requests.put(config.url + '/user/profile/sethandle/v1/', data=input)
