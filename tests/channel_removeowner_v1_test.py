...
def test_valid_channel_remove_channel_owner(clear_and_channel_2_members, channel_details_for_owner):
    ...
    requests.post(config.url + 'channel/removeowner/v1', json={'token': token, 'channel_id': channel_id, 'u_id': u_id_2})
...
def test_invalid_channel():
    ...
    channel_removeowner = requests.post(config.url + 'channel/removeowner/v1', json={'token': token, 'channel_id': 1, 'u_id': u_id})
...
def test_invalid_u_id(clear_and_channel_2_members):
    ...
    while (invalid_u_id == u_id or invalid_u_id == u_id_2):
        invalid_u_id += 1
    channel_removeowner = requests.post(config.url + 'channel/removeowner/v1', json={'token': token, 'channel_id': channel_id, 'u_id': invalid_u_id})
    assert channel_removeowner.status_code == InputError.code()
...
def test_not_channel_owner(clear_and_channel_2_members):
    ...
    channel_removeowner = requests.post(config.url + 'channel/removeowner/v1', json={'token': token, 'channel_id': channel_id, 'u_id': u_id_2})
    assert channel_removeowner.status_code == InputError.code()
...
def test_only_channel_owner(clear_and_channel_2_members):
    ...
    channel_removeowner = requests.post(config.url + 'channel/removeowner/v1', json={'token': token, 'channel_id': channel_id, 'u_id': u_id})
    assert channel_removeowner.status_code == InputError.code
...
def test_no_owner_permissions(clear_and_channel_2_members):
    ...
    channel_removeowner = requests.post(config.url + 'channel/removeowner/v1', json={'token': token_2, 'channel_id': channel_id, 'u_id': u_id})
...
def invalid_token_valid_channel(clear_and_channel_2_members):
    ...
    channel_addowner = requests.post(config.url + 'channel/addowner/v1', json={'token': token, 'channel_id': channel_id, 'u_id': u_id_2})
    channel_removeowner = requests.post(config.url + 'channel/removeowner/v1', json={'token': invalid_token, 'channel_id': channel_id, 'u_id': u_id_2})
    assert channel_removeowner.status_code == AccessError.code
...
def invalid_token_invalid_channel(clear_and_channel_2_members):
    ...
    channel_addowner = requests.post(config.url + 'channel/addowner/v1', json={'token': token, 'channel_id': channel_id, 'u_id': u_id_2})
    channel_removeowner = requests.post(config.url + 'channel/removeowner/v1', json={'token': invalid_token, 'channel_id': invalid_channel_id, 'u_id': u_id_2})
    assert channel_removeowner.status_code == AccessError.code
